            ...
            runners.append(
                {
                    ...
                    "horseRecentWinRate5": _float_value(row, "horse_recent_win_rate_5"),
                    "horseRecentPlaceRate5": _float_value(row, "horse_recent_place_rate_5"),
                    "horseAvgFinishLast3": _float_value(row, "horse_avg_finish_last3"),
                    "horseAvgFinishLast5": _float_value(row, "horse_avg_finish_last5"),
                    "horseWinRateLifetime": _float_value(row, "horse_win_rate_lifetime"),
                    "horsePlaceRateLifetime": _float_value(row, "horse_place_rate_lifetime"),
                    "horseAvgOddsRankLast3": _float_value(row, "horse_avg_odds_rank_last3"),
                    "horseAvgOddsLast3": _float_value(row, "horse_avg_odds_last3"),
                    "horseWeightChangeFromLast": _float_value(row, "horse_weight_change_from_last"),
                    "horseWeightChangeRate": _float_value(row, "horse_weight_change_rate"),
                    "distanceChange": _float_value(row, "distance_change"),
                    "distanceAbsChange": _float_value(row, "distance_abs_change"),
                    "surfaceSwitch": _float_value(row, "surface_switch"),
                    "jockeySwitch": _float_value(row, "jockey_switch"),
                    "carriedWeightChange": _float_value(row, "carried_weight_change"),
                    "jockeyRecentWinRate50": _float_value(row, "jockey_recent_win_rate_50"),
                    "jockeyRecentPlaceRate50": _float_value(row, "jockey_recent_place_rate_50"),
                    "trainerRecentWinRate50": _float_value(row, "trainer_recent_win_rate_50"),
                    "trainerRecentPlaceRate50": _float_value(row, "trainer_recent_place_rate_50"),
                    "horseJockeyWinRate": _float_value(row, "horse_jockey_win_rate"),
                    "horseJockeyPlaceRate": _float_value(row, "horse_jockey_place_rate"),
                    "jockeyTrainerWinRate": _float_value(row, "jockey_trainer_win_rate"),
                    "jockeyTrainerPlaceRate": _float_value(row, "jockey_trainer_place_rate"),
                    "sireWinRate": _float_value(row, "sire_win_rate"),
                    "sirePlaceRate": _float_value(row, "sire_place_rate"),
                    "damSireWinRate": _float_value(row, "dam_sire_win_rate"),
                    "damSirePlaceRate": _float_value(row, "dam_sire_place_rate"),
                    "sireSurfacePlaceRate": _float_value(row, "sire_surface_place_rate"),
                    "damSireSurfacePlaceRate": _float_value(row, "dam_sire_surface_place_rate"),
                    "sireDistancePlaceRate": _float_value(row, "sire_distance_place_rate"),
                    "damSireDistancePlaceRate": _float_value(row, "dam_sire_distance_place_rate"),
                    ...
                    "logMarketOdds": _float_value(row, "log_market_odds"),
                    "oddsToFavorite": _float_value(row, "odds_to_favorite"),
                    "favoriteMarketOdds": _float_value(row, "favorite_market_odds"),
                    "marketTop3Probability": _float_value(row, "market_top3_probability"),
                    "marketEntropy": _float_value(row, "market_entropy"),
                    "marketRankPct": _float_value(row, "market_rank_pct"),
                    "carriedWeightVsField": _float_value(row, "carried_weight_vs_field"),
                    "horseWeightVsField": _float_value(row, "horse_weight_vs_field"),
                    "ageVsField": _float_value(row, "age_vs_field"),
                    "restVsField": _float_value(row, "rest_vs_field"),
                    "avgSpeedVsField": _float_value(row, "avg_speed_vs_field"),
                    "recentPlaceVsField": _float_value(row, "recent_place_vs_field"),
                    "jockeyWinVsField": _float_value(row, "jockey_win_vs_field"),
                    "trainerWinVsField": _float_value(row, "trainer_win_vs_field"),
                    "drawBiasVsField": _float_value(row, "draw_bias_vs_field"),
